...
/*   Updated: 2022/08/20 17:01:44 by ntan             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(Form &form)
{
	...
	else
	{
		...
		{
			std::cout << this->name << " signed the " << form.getName() << " Form." << std::endl;
			form.doSign();
		}
		else
		{
...
void	Bureaucrat::executeForm(Form const &form)
{
	...
	{
		std::cout << this->name << " could not execute the " << form.getName() << " Form because his grade is too low. ( " << this->getGrade() << " need " << form.getExecGrade() << " )" << std::endl;
	}
	else
	{
		if (form.isSigned() == false)
		{
			std::cout << this->name << " could not execute the " << form.getName() << " because it is not signed." << std::endl;
		}
		else
		{
			std::cout << this->name << " execute the " << form.getName() << std::endl;
			form.execute(*this);
		}
	}
}
