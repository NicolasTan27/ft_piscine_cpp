...
/*   Updated: 2022/08/20 18:49:07 by ntan             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << this->_name << " Form Constructor with sign/execution grade : " << this->_signGrade << "/" << this->_execGrade << ", target : " << this->_target << std::endl;
	if (signGrade < 1)
